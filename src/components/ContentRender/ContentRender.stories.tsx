...
<head>
    ...
    <title>春节习俗演变对比</title>
    <style>
        * { box-sizing: border-box; font-family: sans-serif; }
        body { background: #f8fafc; padding: 20px; color: #334155; }
        .container { max-width: 1000px; margin: 0 auto; }
        h2 { color: #1e293b; text-align: center; margin-bottom: 10px; }
        .subtitle { text-align: center; color: #64748b; margin-bottom: 30px; }
        .table-wrapper { overflow-x: auto; background: white; border-radius: 12px; box-shadow: 0 4px 12px rgba(15, 99, 238, 0.08); padding: 20px; }
        table { width: 100%; border-collapse: collapse; min-width: 700px; }
        th { background-color: #0F63EE; color: white; font-weight: bold; text-align: center; padding: 18px 15px; position: sticky; top: 0; }
        td { padding: 20px 15px; border-bottom: 1px solid #e2e8f0; vertical-align: top; }
        tr:hover { background-color: #f1f5f9; }
        .era-name { color: #0F63EE; font-weight: bold; font-size: 1.1em; margin-bottom: 5px; }
        .era-desc { color: #475569; font-size: 0.95em; line-height: 1.5; }
        .detail-panel { display: none; background: #f0f7ff; border-left: 4px solid #0F63EE; padding: 20px; margin-top: 15px; border-radius: 0 8px 8px 0; }
        .detail-panel.active { display: block; animation: fadeIn 0.3s ease; }
        .detail-title { color: #1e293b; font-weight: bold; margin-bottom: 10px; }
        .detail-content { color: #475569; line-height: 1.6; }
        .highlight { background-color: #e0f2fe; padding: 2px 6px; border-radius: 4px; font-weight: 500; }
        @keyframes fadeIn { from { opacity: 0; } to { opacity: 1; } }
        .tip { text-align: center; color: #94a3b8; font-size: 0.9em; margin-top: 15px; }
    </style>
</head>
<body>
    <div class="container">
        <h2>春节习俗“功能迭代”史</h2>
        <p class="subtitle">点击任意行，查看该时期习俗的详细解读与核心需求</p>
        <div class="table-wrapper">
            <table id="customsTable">
                <thead>
                    <tr>
                        <th width="20%">历史时期</th>
                        <th width="40%">主要习俗特点</th>
                        <th width="40%">核心需求与象征</th>
                    </tr>
                </thead>
                <tbody>
                    <tr onclick="toggleDetail(1)">
                        <td><div class="era-name">古代 (汉-唐)</div><div class="era-desc">奠基与定型期</div></td>
                        <td>驱邪仪式（爆竹）、祭祀祖先、饮椒柏酒、拜年（官方层面）</td>
                        <td><span class="highlight">生存与平安</span>。核心是驱赶“年”兽（自然灾害的象征），祈求家族平安、远离疫病。</td>
                    </tr>
                    <tr onclick="toggleDetail(2)">
                        <td><div class="era-name">近代 (宋-清)</div><div class="era-desc">繁荣与普及期</div></td>
                        <td><strong>贴春联</strong>（桃符演变）、<strong>守岁</strong>、<strong>吃年夜饭</strong>（团圆饭）、<strong>发压岁钱</strong>、逛庙会</td>
                        <td><span class="highlight">团圆与祈福</span>。社会安定后，重点转向家庭团聚、情感联结，并祈求财富与好运。</td>
                    </tr>
                    <tr onclick="toggleDetail(3)">
                        <td><div class="era-name">现代 (当代)</div><div class="era-desc">融合与创新期</div></td>
                        <td>看春晚、短信/电子红包拜年、旅游过年、集五福、家庭观影</td>
                        <td><span class="highlight">联结与娱乐</span>。在快节奏和物理距离下，通过新媒介维系情感，并追求节日的精神放松与娱乐。</td>
                    </tr>
                </tbody>
            </table>
        </div>
        <p class="tip">💡 提示：点击表格中的行，查看详细解读</p>

        <!-- 详情面板 -->
        <div id="detailPanel1" class="detail-panel">
            <div class="detail-title">古代习俗深度解读</div>
            <div class="detail-content">
                <p><strong>爆竹</strong>：最初真是燃烧竹子，使其爆裂发声，用以吓退想象中的邪祟。这就像你项目开始时的一个“强力启动仪式”，旨在清除一切不利因素。</p>
                <p><strong>祭祀祖先</strong>：这是“汇报工作”与“寻求支持”。感谢祖先上一年的庇佑，并祈求新一年的继续关照，体现了深厚的家族延续观念。</p>
                <p><strong>核心洞察</strong>：这个时期的习俗充满了<strong>实用主义</strong>色彩，一切为了<strong>安全与生存</strong>这个最根本的需求。对于收入不稳定的自由职业者来说，这就好比注重基础保障、规避重大风险。</p>
            </div>
        </div>
        <div id="detailPanel2" class="detail-panel">
            <div class="detail-title">近代习俗深度解读</div>
            <div class="detail-content">
                <p><strong>春联的演变</strong>：最早是桃木板上画门神（神荼、郁垒），称为“桃符”，用于驱鬼。后来纸上写吉祥话，成了“春联”。功能从“驱邪”转向了“纳福”，是心态变得积极开放的体现。</p>
                <p><strong>年夜饭与守岁</strong>：这是一年中最重要的一顿家庭聚餐，强调<strong>团圆</strong>。守岁则是全家一起熬夜迎接新年，寓意珍惜光阴、为长辈祈福延寿。这就像你定期进行的“家庭会议”和“年度复盘”，强化纽带，规划未来。</p>
                <p><strong>压岁钱</strong>：最初是用于镇压“祟”这个妖怪，保护小孩。后来演变为长辈给予晚辈的祝福和关爱，象征着财富的传递与美好祝愿。</p>
                <p><strong>核心洞察</strong>：经济文化繁荣后，习俗变得更<strong>情感化、生活化</strong>。重点从“怕坏事发生”转向了“盼好事来临”。对你而言，这阶段就像业务稳定后，开始追求工作与生活的平衡，以及家庭的情感支持。</p>
            </div>
        </div>
        <div id="detailPanel3" class="detail-panel">
            <div class="detail-title">现代习俗深度解读</div>
            <div class="detail-content">
                <p><strong>春晚</strong>：自1983年起，成为新的“电子守岁”仪式。它创造了一种“天涯共此时”的集体认同感，是科技与传统结合的典范。</p>
                <p><strong>电子红包</strong>：解决了物理距离问题，让祝福即时可达。它继承了压岁钱的“祝福”内核，但形式变得无比便捷，适应了移动互联网时代的人际交往模式。</p>
                <p><strong>旅游过年</strong>：从“回家团圆”到“出门团圆”，反映了生活方式的多元化选择。就像自由职业可以选择在任何地方工作一样，过年的形式也变得更加自由。</p>
                <p><strong>核心洞察</strong>：现代习俗的核心是<strong>适应与联结</strong>。用新技术解决旧问题（如距离），用新形式满足旧需求（如祝福）。这完美呼应了你作为自由职业者，必须不断<strong>利用新工具、适应新环境</strong>来维持发展和人际网络的核心能力。</p>
            </div>
        </div>
    </div>
</body>

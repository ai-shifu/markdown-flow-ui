...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <span
      ...
      role="group"
      className={cn(
        "bg-white group/input-group border-input dark:bg-input/30 relative flex items-center rounded-md border shadow-xs transition-[color,box-shadow] outline-none",
